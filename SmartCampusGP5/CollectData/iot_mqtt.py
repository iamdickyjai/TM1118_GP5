...
def mqtt_on_message(client, userdata, msg):
    ...
    #     
    print("yoyoyoyoyo")
    p = Data(node_id=iotData["node_id"], loc=iotData["loc"], temp=iotData["temp"], hum=iotData['hum'], light=iotData['light'], snd=iotData['snd'] )
    p.save()


mqtt_client = mqtt.Client("Testingman") # Create a Client Instance
